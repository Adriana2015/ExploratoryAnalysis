...
png( file = "plot2.png",width = 480, height = 480, units = "px",pointsize = 15,bg= "white" ) 
with(datag, plot(Date2, Global_active_power, type="l", lwd=1, ylab= "Global Active Power (kilowatts)", xlab=""))
